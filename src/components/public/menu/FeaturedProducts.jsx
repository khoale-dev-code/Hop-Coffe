...
function getDisplayOldPrice(item, displayPrice) {
  ...
  const sizeWithSale = sizes.find(
    (size) => Number(size.oldPrice || 0) > Number(displayPrice || 0)
  );

  if (sizeWithSale?.oldPrice) return Number(sizeWithSale.oldPrice || 0);
          ...
          <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
            <div className="border-b border-neutral-200 bg-white p-3 lg:border-b-0 lg:border-r lg:p-5">
              <div className="relative overflow-hidden rounded-[8px] border border-neutral-200 bg-white">
                <div className="grid h-[320px] place-items-center overflow-hidden bg-white min-[430px]:h-[350px] sm:h-[390px] lg:h-[520px]">
                  {activeImage?.url ? (
                    <img
                      src={activeImage.url}
